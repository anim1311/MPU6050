...
/**  Unified Sensor interface for temperature component of MPU6050 */
...
/**  Unified Sensor interface for accelerometer component of MPU6050 */
class MPU6050_Accelerometer : public Sensor {
public:
  /** @brief Create an Sensor compatible object for the accelerometer
     sensor
      @param parent A pointer to the MPU6050 class */
...
/**  Unified Sensor interface for gyro component of MPU6050 */
class MPU6050_Gyro : public Sensor {
public:
  /** @brief Create an Sensor compatible object for the gyro sensor
      @param parent A pointer to the MPU6050 class */
...
protected:
  ...
  MPU6050_Temp *temp_sensor = NULL; ///< Temp sensor data object
  MPU6050_Accelerometer *accel_sensor =
      NULL;                                  ///< Accelerometer data object
  MPU6050_Gyro *gyro_sensor = NULL; ///< Gyro data object
...
private:
  friend class MPU6050_Temp; ///< Gives access to private members to
                                      ///< Temp data object
  friend class MPU6050_Accelerometer; ///< Gives access to private
                                               ///< members to Accelerometer
                                               ///< data object
  friend class MPU6050_Gyro; ///< Gives access to private members to
                                      ///< Gyro data object
